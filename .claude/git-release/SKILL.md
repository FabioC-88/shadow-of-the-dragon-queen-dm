...
name: git-release
description: >
  Workflow completo di release per il modulo Foundry VTT Shadow of the Dragon Queen DM: build → aggiorna
...
Gestisci la release completa del modulo Shadow of the Dragon Queen DM su GitHub e Foundry VTT.
