...
**4 Guard montate su 3 Warhorse** (era 3+3 — scalate per il quinto giocatore). Schede ufficiali MM'25, verificate il 2026-09-13.  
GUARD (×4) — MM'25 p162, scheda ufficiale (verificata 2026-09-13)  
 Small or Medium Humanoid, Neutral | AC 16 | Initiative +1 (11)  
 HP 11 (2d8+2) | Speed 30 ft. | CR 1/8 (XP 25; PB +2)  
 STR 13 (+1, save +1)   DEX 12 (+1, save +1)   CON 12 (+1, save +1)  
 INT 10 (+0, save +0)   WIS 11 (+0, save +0)   CHA 10 (+0, save +0)  
 Skills Perception +2 | Gear Chain Shirt, Shield, Spear  
 Senses Passive Perception 12 | Languages Common  
   
 ACTIONS  
 Spear. Melee or Ranged Attack: +3, reach 5 ft. or range 20/60 ft.  
   Hit: 4 (1d6+1) Piercing damage.  
   
 [UNA sola arma: la lancia. Le bozze precedenti le davano Crossbow +  
   Shortsword, che la Guard non ha. Passive Perception 12, non 10.]  
*Consiglio pac* *ing (senza Minion): con soli 4-7 nemici dello stesso blocco, la scorciatoia più semplice resta far agire tutte le Guard sulla stessa iniziativa condivisa (una tirata sola per il gruppo) — nessuna regola nuova da imparare, solo meno colpi di dado.*  
WARHORSE (×3) — MM'25 p373, scheda ufficiale (verificata 2026-09-13)  
...
   
 [La carica e' DENTRO l'attacco: nessun tiro salvezza, nessuna azione bonus,  
   un solo attacco di Zoccoli per turno. Danno base 2d4+4 (9), non 2d6+4.  
   Le bozze precedenti avevano prima un Multiattack, poi una Trampling Charge  
   con TS Forza CD 14 + attacco bonus: entrambe sbagliate.]  
   
**Meccaniche di campo (Mappa 3.2):** invariate — la Mischia/Fray (DC 16 Dexterity save o 2d6 slashing a chi entra/inizia il turno lì), muri/carro come mezza copertura, tabella eventi d4 a Iniziativa 0 (evento "4 — Guard nemica, 6 HP, dalla Fray" invariato).  
**Encounter 2 — Gragonis Arriva (Boss Action-Oriented)**  
**5 Guard aggiuntive (stesso blocco ufficiale sopra, era 4)** +  **Gragonis**. Non è il boss di capitolo (quello è Gholcag, sotto) — niente Villain Actions: solo Bonus Action e Reaction per non farlo morire al primo round contro 5 iniziative, senza il macchinario narrativo riservato ai boss veri.  
...
   
KAPAK DRACONIAN (Ambusher) — base ufficiale DSotDQ p198 + 2 aggiunte homebrew  
...
   muoversi di 20 ft senza provocare attacchi di opportunita'. Serve il suo  
   ruolo mordi-e-fuggi: colpisce un PG isolato e sparisce prima che lo circondino.  
   
