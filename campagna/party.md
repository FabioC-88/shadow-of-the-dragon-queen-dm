...
**[NOTA DM — riservata] Attenzione a Duskwalker (S19 FASE 1).** Il treant risparmia chi mostra apertamente il simbolo di un dio della natura — *"Chislev, Habbakuk o Zeboim"* — **o** chi è "chiaramente un servitore della natura". La seconda clausola è la porta dell'8° livello di Asurion; la prima, con Corin al tavolo, scatta per prima e rischia di cancellargli la scena. Tre soluzioni proposte in `fonti/personaggi/Corin-Wrenmoor.md`, sezione "Il rischio Duskwalker" — **da concordare con Seba, perché è la sua scena.**
---
...
| **Corin** | Il Lago di Jamir — l'equilibrio che costa *(proposta)* | **S19** FASE 2 — Tempio di Paladine, Città dei Nomi Perduti | **War Caster** *(consigliato — la scelta è di Gabri)* |
