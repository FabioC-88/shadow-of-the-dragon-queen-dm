# Fazioni — Shadow of the Dragon Queen

> Aggiorna dopo ogni sessione rilevante.
> **Posizioni verso il party:** Ostile · Diffidente · Neutrale · Amichevole · Alleata
...
| Campo | Valore |
|-------|--------|
| **Posizione verso il party** | Ostile |
| **PNG di contatto** | Kansaldi Fire-Eyes (nemica), Lohezet, Belephaion, Lord Soth |
...
| **PNG di contatto** | **Wyhan** (ex Maga di magia nera, in pensione); **Demelin** (Cap 6, spirito) |
| **Sede operativa** | Ordine distribuito; Wyhan ha un'apotecaria a Kalaman |
| **Obiettivo** | Preservare la conoscenza magica; non schierati nella guerra |

**Tre ordini:**
- **Mantello Bianco** (Solinari) — Magia del bene; allineamento BN
...
### Lord Soth e i Cavalieri Non-morti
...
- Nessuna fazione del party ha **missioni secondarie strutturate** — questa campagna è lineare
- Le fazioni servono per dare **stake narrativi** e **PNG ricorrenti** con cui i PG costruiscono relazioni
- La posizione verso il party cambia dinamicamente — traccia in `rapporti.md`
