...
*[NOTA DM — riservata] Attiva solo per i PG che hanno vissuto il preludio corrispondente. Il party non è ancora definito nei file (`campagna/party.md` in TBD e nessun file in `fonti/personaggi/`); questi hook seguono l'impostazione delle Sessioni 03–05, basata sui preludi del manuale. Aggiorna quando i PG reali saranno noti.*
...
*(vedi tabella completa "🧩 THREAD NARRATIVI SETUP [S07]" sopra)*
