...
## FASE 0 — Orientamento in Città e Strumenti del DM
...
Mentre il gruppo attraversa le strade della Città dei Nomi Perduti dirigendosi verso la Magione Occupata, usa la tabella seguente per descrivere scorci delle rovine.

##### Scorci della Città (d6)

| d6 | Visione |
|:---:|---------|
| 1 | Uno scheletro umanoide giace sotto un acquedotto crollato. Stringe un *pugnale*, e sul ciottolato vicino qualcuno ha inciso le parole "ce lo meritiamo". |
| 2 | In fondo a un viale si ergono due piedi di marmo enormi — il resto della statua è scomparso. |
| 3 | I resti parziali di un drago di bronzo adulto giacciono ammucchiati tra due edifici. |
| 4 | Una torre circolare trafigge una cupola come una lancia. |
| 5 | Liane rampicanti coprono un murale del sommo sacerdote — un uomo severo, incoronato da una luce fiammeggiante. |
| 6 | Un lato di una lunga faglia si è sollevato di tre metri, tranciando gli edifici in due. |

*[Aggiunta atmosferica]:*
> *Ognuna di queste immagini racconta la stessa storia da un'angolazione diversa: qualcosa di enorme è caduto qui, e nessuno l'ha mai davvero rimosso. Onyari non è stata ricostruita. È stata solo, in qualche modo, sopravvissuta a sé stessa.*

##### Incontri Casuali in Città (d8)

*[NOTA DM — riservata] Tira su questa tabella durante gli spostamenti tra location, o ogni volta che ti sembra opportuno — non è pensata per scattare a ogni scena. Tutti questi incontri richiedono schede di *appendix B* non disponibili in questo estratto: se ne attivi uno, tratta le creature draconiane con le schede ricostruite più sotto (Kapak già disponibile dalla Sessione 05, Sivak ricostruito in questa sessione), e improvvisa liberamente per le voci più esotiche (death slaad, Istarian drone, ciclopi) se compaiono — non sono pensate per essere incontri risolutivi di questa sessione.*
...
**Pattuglia.** Cinque **draconiani kapak** pattugliano la città seguendo un percorso prevedibile e, dopo un'ora di cammino, fanno rapporto al loro quartier generale (la Magione Occupata).
...
| d4 | Informazione |
|:---:|--------------|
| 1 | Gli ingegneri lavorano per rinforzare le fondamenta e assicurarsi che i vari quartieri poggino su roccia solida. |
| 2 | Il prigioniero riceve ordini dai comandanti in una magione occupata vicino al centro della città. |
| 3 | Il Tempio di Paladine nel quartiere nord-occidentale è invaso da una vegetazione pericolosa. Le pattuglie mandate lì non sono tornate. |
| 4 | Un mago in veste nera di nome **Lohezet** e la sacerdotessa di Takhisis **Belephaion** guidano le forze in città. Passano il tempo alla Soglia dei Cieli, ma nessuno può entrarci senza una parola d'ordine (che il prigioniero non conosce). |

---

### Il Tempio Sinistro all'Orizzonte — il Bastione di Takhisis
...
**Attitudine PNG in questa scena:** *(nessun PNG nominato — solo tabelle strumento e una visione a distanza)*

---

## FASE 1 — L'Esterno e l'Ingresso della Magione (O1–O3)
...
### Testo — La Magione in Fondo alla Fila [BT-01]

> In fondo a una fila di rovine si erge un maniero parzialmente intatto. La maggior parte del lato est della struttura è crollata, ma il resto della casa è stato sgomberato e reso di nuovo agibile. Nell'angolo sud-est, una rimessa per carrozze attaccata alla casa sorge accanto all'ingresso principale.

*[Aggiunta atmosferica]:*
> *È la prima cosa che vedete da giorni che sembra davvero *manutenuta* — non restaurata con amore, come Thornwall Keep a Vogler, ma tenuta in ordine con la disciplina fredda di chi obbedisce a un regolamento. Torce nuove infisse in vecchi candelabri. Finestre sbarrate con assi tagliate di fresco. La città morta, qui, ha un inquilino vivo e organizzato.*

Questo posto di comando ribolle di attività durante il giorno, con pattuglie umane e draconiane che vanno e vengono. Di notte, continuano solo le pattuglie draconiane.
...
### Testo — Ganci per Mantelli e Lance Appoggiate [BT-02]

> Questo ingresso ha una nicchia rivestita di ganci ornati per mantelli, sotto una fila di mensole. Mantelli antipioggia macchiati sovraccaricano attualmente i ganci, e diverse lance sono appoggiate contro la parete. Porte conducono a nord e a sud.
...
### O3 — La Rimessa per Carrozze

Due serie di porte scorrevoli in metallo conducono alla rimessa. Fanno rumore considerevole quando vengono aperte, allertando le creature all'interno. Un personaggio che origlia a queste porte e supera una prova di **Saggezza (Percezione) CD 14** sente ringhi provenire dall'interno. Quando i personaggi aprono una porta, leggi o parafrasa quanto segue:

### Testo — Il Carro-Prigione [BT-03]

> Questa rimessa presenta box per cavalli a est e uno spazio aperto a ovest. Due ampie porte carraie conducono alla strada. Un carro-prigione rinforzato in metallo sta nell'angolo nord-ovest, e scuote occasionalmente mentre qualcosa ringhia al suo interno.

*[Aggiunta atmosferica]:*
> *Il carro trema con una regolarità quasi meccanica — non i sussulti casuali di un animale spaventato, ma qualcosa che ha smesso da tempo di sprecare energie nel panico e si limita, ostinatamente, a testare le sbarre a ogni respiro.*

Questa rimessa funge da prigione della base.
...
**Attitudine PNG in questa scena:** *(nessun PNG nominato — guardie draconiane senza identità propria)*

---

## FASE 2 — Sala da Pranzo e Cucina (O4–O7)

*~35 minuti · La mensa affollata, il corridoio verso le rovine, Yurl il cuoco, la cassaforte del comandante Belephaion*

### O4 — Il Salotto

### Testo — Il Fuoco nel Camino di Marmo [BT-04]

> Un fuoco arde nel camino di marmo di questo ampio salotto. Le alte finestre della stanza sono state sbarrate con assi, e i suoi arredi marciti sono stati spinti da parte per far posto a tavoli da pranzo spaiati e scheggiati. Sul lato nord della stanza, una scalinata curva sale tra la porta posteriore e un corridoio. Sul lato sud, una porta conduce a sud e un'altra a est.
...
### O5 — Il Corridoio Inferiore

Questo corridoio conduce alle aree O6 e O8, per poi terminare in un cumulo di macerie dove l'ala est della casa è crollata tempo addietro. La porta all'estremità est del corridoio si apre su una stanza collassata, anch'essa piena di macerie.

*[NOTA DM — riservata] Nessun incontro qui — puro corridoio di passaggio. Buon momento per un breve respiro tattico tra la mensa (O4) e la cucina (O6).*

---

### O6 — La Cucina

### Testo — Arrosti sugli Spiedi [BT-05]

> Accanto a una piccola porta della dispensa, un fuoco arde nel focolare della cucina. Sopra di esso, diversi grandi arrosti pendono dagli spiedi. I tavoli sono coperti di farina e altri ingredienti. Altre porte conducono a ovest e a nord.

*[Aggiunta atmosferica]:*
> *L'odore di carne arrosto dovrebbe essere rassicurante — è uno degli odori più antichi e umani che esistano. Ma mescolato al fumo acre delle torce e a qualcosa di più metallico, sotto, il profumo perde ogni innocenza molto prima che si scorga il macellaio.*

Il cuoco del posto di comando, **Yurl**, è uno scheletrico **capitano hobgoblin**. Il suo grembiule è coperto di macchie raccapriccianti, che crescono di minuto in minuto mentre affetta la carcassa di uno sciacallo con un'ascia da macellaio sovradimensionata. Se Yurl individua degli intrusi, attacca con l'ascia (che usa le statistiche del suo attacco con Spadone).

Nella tasca del grembiule di Yurl si trova la chiave dell'area O7, insieme a una manciata di denti animali che ha collezionato.

***Porta della Dispensa.*** La porta dell'area O7 è chiusa a chiave. Un personaggio può aprirla usando la chiave di Yurl o superando una prova di **Destrezza CD 16** con gli strumenti da scasso.

### Stat Block — Yurl (Capitano Hobgoblin, Cuoco) · CR 3 · 700 XP *(riutilizzo adattato dalla scheda di Urta, Sessione 13)*

```
YURL — umanoide Medio (hobgoblin), legale malvagio
CA 17 (cotta di maglia, scudo appeso vicino al focolare — non indossato)   PF 39 (6d8+12)   Velocità 9 m
...
—
Vantaggio Marziale. Una volta per turno, Yurl infligge 7 (2d6) danni extra a una creatura che colpisce con un attacco d'arma, se almeno un alleato di Yurl si trova entro 1,5 m dalla creatura e non è incapacitato.
—
AZIONI
Ascia da Macellaio (Spadone). Attacco con arma in mischia: +4 al colpire, portata 1,5 m. Colpito: 7 (2d6+2) danni taglienti.
```

*[NOTA DM — riservata] **Riutilizzo dichiarato, non ricostruzione da zero.** Yurl condivide l'ossatura meccanica di Urta (CR 3, "capitano hobgoblin" standard) — la fonte specifica letteralmente che il suo attacco "usa le statistiche del suo attacco con Spadone", quindi ho sostituito Spada Lunga/Arco Lungo di Urta con un singolo attacco da Spadone (2d6+2 taglienti), rimuovendo l'opzione a distanza (Yurl è un cuoco, non un arciere) e il tratto Comando (non ha subordinati diretti in cucina). Yurl **non indossa l'armatura** mentre cucina — se sorpreso senza tempo di prepararsi, considera di concedergli CA più bassa (13, solo Destrezza) finché non ha almeno un turno per reagire.*

---

### O7 — La Dispensa

### Testo — Casse e Vetri Colorati [BT-06]

> Questa dispensa è stipata di rifornimenti, dalle gallette al vestiario, dalle armi alle armature. Sebbene la maggior parte delle casse sia di legno grezzo, una cassa metallica è incisa con disegni di draghi blu.

*[Aggiunta atmosferica]:*
> *L'incisione dei draghi blu, a guardarla da vicino, è opera di una mano esperta — troppo elaborata per essere semplice decorazione militare. Qualcuno, per questa cassa, ha voluto qualcosa che assomigliasse più a un reliquiario che a un forziere.*
...
**Attitudine PNG in questa scena:** *(nessun PNG nominato — Yurl e le guardie sono ostili generici senza personalità sviluppata oltre la loro funzione)*

---

## FASE 3 — La Caserma (O8)

*~15 minuti · Gli otto soldati addormentati, l'imboscata capovolta*

### O8 — Il Salotto (Caserma)

### Testo — Brande e Mosaici Screpolati [BT-07]

> File di brande identiche e zaini logori affollano il pavimento di questa stanza. Le pareti sono ricoperte di mosaici ornati, sgretolati dall'età.
...
**Attitudine PNG in questa scena:** *(nessun PNG nominato)*
...
### O9 — Il Corridoio Superiore

La scala della magione collega questo piccolo corridoio all'area O4 al piano terra. A est, il corridoio termina in un muro crollato. A nord-ovest, una porta conduce a un piccolo balcone affacciato sul patio.

*[NOTA DM — riservata] Nessun incontro — corridoio di passaggio verso il cuore amministrativo della magione.*

---

### O10 — La Camera Padronale

### Testo — La Torretta col Panorama [BT-08]

> Questa camera da letto è ben conservata, con un letto a baldacchino, una scrivania, e un piccolo forziere. Una torretta rotonda a sud-est — con i vetri ancora intatti nelle finestre — offre una vista panoramica sulle macerie del quartiere. Una porta conduce a una stanza a est, e un'altra si apre sul corridoio a nord.
...
### Testo — Scrivanie sotto le Finestre [BT-09]

> La maggior parte dei libri di questa biblioteca è marcita, ma due scrivanie sotto alte finestre sono coperte di documenti e candele. Una porta conduce a una stanza a ovest, un'altra si apre sul corridoio a nord.
...
*[NOTA DM — riservata] **Conferma diretta di quanto già accennato da Demelin.** Nota che questa lista di informazioni sovrappone e conferma quanto la maga aveva già detto nella Sessione 17 (pattuglie concentrate sulla Soglia dei Cieli, sospetto di un posto di comando) — è un buon momento per far notare ai giocatori che le fonti indipendenti (Demelin, i documenti di Hask, gli scrivani) si confermano a vicenda, rafforzando la fiducia nell'accuratezza dell'intelligence raccolta prima di dirigersi verso la Soglia in una sessione futura.*
...
*[NOTA DM — riservata] Come nelle Sessioni 00–17, il party non è ancora definito nei file (`campagna/party.md` in TBD, nessuna cartella `fonti/personaggi/`); questi hook seguono l'impostazione basata sui tre preludi canonici del manuale. Aggiorna quando i PG reali saranno noti.*
...
## 🧩 THREAD NARRATIVI SETUP [S19]

*[NOTA DM — riservata] Come nelle Sessioni 04–17, questa campagna non prevede missioni secondarie strutturate per fazioni (vedi `campagna/missioni-secondarie.md` e `campagna/fazioni.md`): l'Agente 4 ha verificato entrambi i file e non ha trovato missioni `In corso` o `Pianificate` da integrare in questa sessione. I thread seguenti sono narrativi/di location e di capitolo, non meccanici.*

| Thread | Dettaglio | Urgenza |
|--------|-----------|---------|
| La parola d'ordine della Soglia dei Cieli | "Per sua volontà: il mondo" — ottenuta dai rapporti di Hask (O10) | Alta → necessaria per entrare alla Soglia dei Cieli senza combattere (Sessione 20+) |
...
- [ ] Priorità scelta per la Sessione 18: Magione Occupata (assunto) — confermato? Sì / No, il party ha scelto altro: ____________
- [ ] O1 (guardie esterne + pattuglia): combattuto o aggirato con inganno? ____________
- [ ] O2 (uniformi recuperate): Sì / No — usate per infiltrarsi? Sì / No
- [ ] O3 (rimessa, guardie, dragonnel prigioniero): combattuto? ____________ — dragonnel liberato? Sì / No, esito: ____________
- [ ] O4 (mensa — bozak/kapak/soldati): combattuto o evitato con inganno? ____________ — rinforzi da O8 arrivati? Sì / No
...
- [ ] XP combattimento assegnati (variabile, fino a ~9.700 totali se ogni scontro avviene per intero, molti evitabili con l'inganno): ____________
...
*(vedi tabella completa "🧩 THREAD NARRATIVI SETUP [S19]" sopra)*
...
- [ ] `/aggiorna-locations 18` — esegui dopo la sessione (Magione Occupata, tabelle strumento città)
- [ ] `/prep-sessione 19` — prepara la prossima: Tempio di Paladine (righe 4915–5032), inclusa la riforgiatura della *dragonlance* e l'avanzamento a Livello 9
...
**Verifica transizione (Step 1 dell'agente).** `campagna/contesto.md` → Capitolo corrente al momento di aprire questa sessione: **6**. Il contenuto estratto per questa sessione (righe 4710–4913) resta interamente dentro il Cap. 6 (`# Chapter 6: City of Lost Names`, righe 4354–5285). Capitolo della sessione (**6**) = Capitolo corrente (**6**) → condizione **non soddisfatta**.

> ⏭ **Nessuna transizione di capitolo rilevata** (capitolo corrente: 6, sessione: 6). Step saltato.

Nessun file generato, nessuna modifica a `campagna/contesto.md`. La prossima verifica di questo tipo avverrà naturalmente quando una futura sessione (probabilmente non prima della Sessione 20 o 21, vista l'estensione residua del Cap. 6) attraverserà la soglia del Cap. 7.
